...
public class RequestExecutingEventHandler extends AbstractRequestEventHandler<RequestExecutingEvent> {
    public RequestExecutingEventHandler(final Provider<Map<Request, Set<RequestFutureSupport>>> requestFutureSupportMapProvider) {
        super(requestFutureSupportMapProvider);
    }

    @Override
    protected void handleEvent(final RequestExecutingEvent event,
