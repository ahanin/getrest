...
public class RestfulApplicationTest {
    ...
    private RestfulApplication restfulApplication;

    private HttpRequest createRequest(final String uri, final Method method) {
    ...
    public void setUp() throws Exception {
        ...
        final RestfulApplication.ApplicationBuilder application = RestfulApplication.newApplicationBuilder();
        ...
        restfulApplication = new RestfulApplication(Sets.<MessageBodyWriter>emptySet(), Sets.<MessageBodyReader>emptySet(),
                Sets.newHashSet(bookResource, newsResource));
    }

    @Test
    public void testShouldMatchMethodByEquality() throws Exception {
        assertEquals(postBookMethod, restfulApplication.getResourceMethodResolver().getResourceMethod(createRequest("/book", Method.POST)));
    }

    @Test
    public void testShouldMatchGetMethodByUriParam() throws Exception {
        assertEquals(getBookByIsbnMethod, restfulApplication.getResourceMethod(createRequest("/book/17283", Method.GET)));
    }

    @Test
    public void testShouldMatchDeleteMethodByUriParam() throws Exception {
        assertEquals(deleteBookByIsbnMethod, restfulApplication.getResourceMethod(createRequest("/book/17283", Method.DELETE)));
    }

    @Test
    public void testShouldMatchMethodByWildcard() throws Exception {
        assertEquals(allNewsSubpathMethod, restfulApplication.getResourceMethod(createRequest("/news/2012-11-18/all-the-jelly-beans-you-can-eat",
                Method.GET)));
    }
